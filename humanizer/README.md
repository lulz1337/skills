...
ASD-STE100 and Zinsser serve different purposes in this skill. Controlled-language
principles shape the construction: one term per concept, one main idea per
sentence, concrete verbs, explicit actors, unambiguous references, and ordered
...
- [ASD-STE100: About Simplified Technical English](https://www.asd-ste100.org/about_STE.html) - Official overview
- [William Zinsser: On Writing Well](https://markrobertwaldman.com/wp-content/uploads/ncp/Zinsser-on-writing-well.pdf) - Clarity, simplicity, brevity, and humanity
