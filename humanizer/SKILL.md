...
Use ASD-STE100-inspired principles to construct the text:

- Use one consistent term for each concept. Do not cycle through synonyms for variety.
- Put one main idea in each sentence. Split a sentence when its clauses require the reader to untangle separate actions or conditions.
- Prefer concrete verbs and active voice when the actor matters.
- Name the actor, action, object, condition, and result when they are relevant.
- Make references and pronouns unambiguous.
- Limit abbreviations, idioms, metaphors, corporate language, and specialist jargon. Keep an established technical term when it is the precise term the intended reader needs. Do not replace it with a looser paraphrase only to avoid jargon. Define it when necessary.
- Break complicated instructions into ordered steps with one primary action per step.

Use Zinsser's principles to control the result:

- **Clarity:** Make the meaning immediately understandable.
- **Simplicity:** Use the simplest wording that preserves the meaning.
- **Brevity:** Make every word useful, but keep important context and nuance.
- **Humanity:** Make the text sound like a person speaking to another person, not a regulation, corporation, or text generator.

These roles are complementary: controlled-language principles make the text precise and disciplined; Zinsser's principles keep it natural. Do not apply either mechanically. Vary sentence length enough to avoid choppy, monotonous prose.
...
This skill is based on [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup. The patterns documented there come from observations of thousands of instances of AI-generated text on Wikipedia. Its writing standard is also informed by the [official ASD-STE100 description](https://www.asd-ste100.org/about_STE.html) and William Zinsser's *On Writing Well*.
